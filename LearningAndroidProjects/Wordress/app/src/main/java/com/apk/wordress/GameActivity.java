...
public class GameActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionVOList = questionsUtil.getQuestionVOListOfLevel(level);
            ...
            public void run() {
                ...
                if (x==0)
                {
                    if (score>levelHighestScore)
                    {
                        ...
                        long check = helper.updateHighestScore(level,levelHighestScore);
                        if(check<=0) {
    ...
    public void showScore() {
        ...
        Button homeButton = (Button) dialog.findViewById(R.id.homeButton);
